# Architecture — Document Intelligence Pipeline

## Summary

Layout analysis → OCR / Claude Vision fallback → Pydantic-validated field extraction → cross-field validators → confidence-gated routing (auto / human review / VLM).
